  ...
  const handlePrintCashier = async () => {
    ...
    try {
      ...
      const thermalReceiptData = {
        ...
        paymentAmount: (receiptData as any).paymentAmount || receiptData.total,
        changeAmount: (receiptData as any).changeAmount || 0,
    ...
    try {
      for (const transaction of batchTransactions) {
        ...
        const thermalReceiptData = {
          ...
          paymentAmount: (transaction as any).paymentAmount || transaction.total,
          changeAmount: (transaction as any).changeAmount || 0,
